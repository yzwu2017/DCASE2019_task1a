...
train_label_doc = 'fold1_train.csv' # each row is like [filename,label,location,device_id]
test_label_doc = 'fold1_evaluate.csv' # each row is like [filename,label,location,device_id]
